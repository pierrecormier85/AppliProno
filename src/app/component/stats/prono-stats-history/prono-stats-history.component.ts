...
@Component({
  ...
  templateUrl: './prono-stats-history.component.html',
  styleUrls: ['./prono-stats-history.component.css']
})
export class PronoStatsHistoryComponent implements OnInit {
  data1: any[];
  ...
  getTitle(){
    return 'Statistique de la journée '.concat(this.selectedItem.toString());
